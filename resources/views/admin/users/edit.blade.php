    ...
    <div class="wrap">
        ...
        <div class="card">
            <form method="POST" action="{{ route('admin.users.update', $user) }}">
                ...
                <input id="present_address" name="present_address" value="{{ old('present_address', $user->present_address) }}">
            ...
            <form method="POST" action="{{ route('admin.users.destroy', $user) }}" onsubmit="return confirm('Delete this user?')" style="margin-top:12px">
                @csrf
                @method('DELETE')
                <button class="btn" type="submit" style="background:#5a1a1a;color:#ffb4b4">Delete</button>
            </form>
        </div>

...
const socialLinks = [
  ...
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/in/rafi-al-mahmud-498011271/',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Email',
    url: 'mailto:rafi.almahmud.007@gmail.com',
    icon: (
          ...
          <div className="space-y-8">
            <div className="bg-background p-6 rounded-lg border border-surface hover:border-accent transition-colors duration-300">
              ...
              <p className="text-body font-body text-text-secondary mb-4">
                ...
                Whether you need a backend/full-stack developer for your next big idea, want to discuss 
                REST API design, or explore machine learning opportunities, I'd love to hear from you.
              </p>
              <a
                href="mailto:rafi.almahmud.007@gmail.com"
